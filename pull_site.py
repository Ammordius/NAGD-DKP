import re, textwrap, os, pathlib, json, time, random
...
'''
reqs = "requests\nbeautifulsoup4\nlxml\npandas\n"
out_dir = pathlib.Path("/mnt/data")
(out_dir/"pull_roster_full.py").write_text(script, encoding="utf-8")
(out_dir/"requirements.txt").write_text(reqs, encoding="utf-8")
(out_dir/"README.txt").write_text(
"""1) Create cookies.txt containing your Cookie header string (single line).
   Example: _ga=...; gl_data=...; gl[session_id]=...; gl_auto[token]=...; gl_sid=...; cf_clearance=...
...
str(out_dir/"pull_roster_full.py"), str(out_dir/"requirements.txt"), str(out_dir/"README.txt")
